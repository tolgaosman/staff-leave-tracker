  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center justify-center rounded-full bg-destructive/10 p-1 text-destructive hover:bg-destructive/20 active:scale-95 ml-2 transition-colors"
        ...
        <Dialog.Portal>
          ...
          <Dialog.Popup className="fixed left-1/2 top-1/2 z-50 flex w-[90vw] max-w-sm -translate-x-1/2 -translate-y-1/2 flex-col items-center rounded-2xl border border-white/10 bg-surface-1 p-8 shadow-2xl outline-none">
            <div className="absolute right-4 top-4">
              <Dialog.Close className="rounded-full p-1.5 text-on-surface-variant hover:bg-black/5 dark:hover:bg-white/5 active:scale-95 transition-colors">
                <X className="size-5" />
              </Dialog.Close>
            </div>
            ...
            <Dialog.Title className="mb-2 text-center text-xl font-bold text-on-surface">
              İzin Reddedildi
            </Dialog.Title>
            
            <p className="mb-6 text-center text-sm text-on-surface-variant/80">
              Bu izin talebi yönetici tarafından aşağıdaki gerekçe ile reddedilmiştir:
            </p>
            ...
            <Dialog.Close className="mt-8 w-full rounded-xl bg-surface-2 px-4 py-3 font-bold text-on-surface transition-all hover:bg-surface-3 active:scale-95">
              Anladım
            </Dialog.Close>
          </Dialog.Popup>
        </Dialog.Portal>
