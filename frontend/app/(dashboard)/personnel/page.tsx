                  ...
                  <table className="w-full min-w-[800px] border-collapse">
                    <thead>
                      <tr className="border-b border-outline-variant/20 font-mono text-xs uppercase tracking-wider text-on-surface-variant/70">
                        <th className="px-6 py-4 font-bold text-left">Personel</th>
                        <th className="px-6 py-4 font-bold text-center">Departman</th>
                        <th className="px-6 py-4 font-bold text-center">Durum</th>
                        <th className="px-6 py-4 font-bold text-center">Başlangıç Tarihi</th>
                        <th className="px-6 py-4 font-bold text-center">Yıllık İzin (Kalan / Hak)</th>
                        <th className="px-6 py-4 font-bold text-center">Telefon</th>
                    ...
                    <tbody>
                      {filteredPersonnel.map((p) => (
                        ...
                        >
                          ...
                          {/* 2. Sütun: Departman */}
                          <td className="px-6 py-4 text-center text-on-surface-variant font-sans">
                            {p.department}
                          </td>
                          ...
                          <td className="px-6 py-4 text-center text-on-surface-variant font-mono text-xs">
                            {p.startDate ? new Date(p.startDate).toLocaleDateString("tr-TR") : "-"}
                          </td>

                          {/* 4.5. Sütun: Yıllık İzin (Kalan / (Hak Edilen + Devreden)) */}
                          <td className="px-6 py-4 text-center font-mono text-xs whitespace-nowrap">
