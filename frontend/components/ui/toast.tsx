      ...
      toast.custom(
        (t) => (
          <div
            ...
            } cursor-pointer flex items-center gap-3.5 rounded-xl border border-emerald-500/25 bg-surface-1 p-4 shadow-2xl backdrop-blur-md max-w-sm w-full transition-all`}
          >
      ...
      toast.custom(
        (t) => (
          <div
            ...
            className={`${
              t.visible ? "animate-enter" : "animate-leave"
            } cursor-pointer flex items-center gap-3.5 rounded-xl border border-rose-500/25 bg-surface-1 p-4 shadow-2xl backdrop-blur-md max-w-sm w-full transition-all`}
          >
      ...
      return toast.custom(
        (t) => (
          <div
            ...
            className={`${
              t.visible ? "animate-enter" : "animate-leave"
            } cursor-pointer flex items-center gap-3.5 rounded-xl border border-amber-500/25 bg-surface-1 p-4 shadow-2xl backdrop-blur-md max-w-sm w-full transition-all`}
          >
      ...
      toast.custom(
        (t) => (
          <div
            ...
            className={`${
              t.visible ? "animate-enter" : "animate-leave"
            } cursor-pointer flex items-center gap-3.5 rounded-xl border border-cyan-500/25 bg-surface-1 p-4 shadow-2xl backdrop-blur-md max-w-sm w-full transition-all`}
          >
